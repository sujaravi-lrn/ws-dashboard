...
public interface IUserReportsDao {
	...
	public List<ReporteeAndUserCountsData> getDirectReporteeAndUserCountsRegularUser(DrilldownRequestDTO requestDTO, String sameDataHierCol, String supervisorHierCol, String additionalHierCol, String userColValueForSameDataHierCol);
