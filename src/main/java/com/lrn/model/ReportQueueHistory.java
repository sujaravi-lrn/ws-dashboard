...
@Entity
@SequenceGenerator(name = "GEN_SEQ", sequenceName = "REPORT_QUEUE_HISTORY_SEQ", allocationSize=1)
@Table(name = "REPORT_QUEUE_HISTORY")
public class ReportQueueHistory extends AbstractBaseEntity implements Serializable {
	...
	@Transient
	private String filterByColumnDisplayName;
	...
	public String getFilterByColumnDisplayName() {
		return filterByColumnDisplayName;
	}

	public void setFilterByColumnDisplayName(String filterByColumnDisplayName) {
		this.filterByColumnDisplayName = filterByColumnDisplayName;
	}
